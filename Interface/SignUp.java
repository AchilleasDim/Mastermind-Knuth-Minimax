...
public class SignUp extends javax.swing.JFrame {
     ...
     * this class is used whenever a user wishes to create an account , he/she
     * then gets automatically logged in
     */
    public SignUp() {
        initComponents();
    }
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        String passwordRetype = String.valueOf(retypepasswordInput.getPassword());
        ...
        for (int i = 0; i < players.length; i++) {
            ...
            if (usernameInput.getText().trim().equals(Encryption.decrypt(players[i].getUsername()))) {
                usernameIsFree = false;
            }

            if (emailInput.getText().trim().equals(Encryption.decrypt(players[i].getEmail()))) {
                emailIsFree = false;
            }
        ...
        if (usernameIsFree && emailIsFree) {
            ...
            if (usernameInput.getText().trim().isEmpty()) {
                ...
                //assigns an id to the account to be created
                ...
                //sets the active player in the session
                Player activePlayer=p;
                LogIn.setActivePlayer(activePlayer);
